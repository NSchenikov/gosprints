...
!) GetByStatus не кэшировал пустые массивы. if tasks != nil (условие из getByStatus) никогда не выполнится для пустого массива потому что []models.Task{} != nil и len([]models.Task{}) == 0.
